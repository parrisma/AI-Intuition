...
_PERSON = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='phone2', full_name='tutorial.Person.phone2', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_updated', full_name='tutorial.Person.last_updated', index=5,
...
_PERSON.fields_by_name['phone2'].message_type = _PERSON_PHONENUMBER
